...
export const TRANSLATIONS: Record<string, Entry> = {
  ...
  '英文單字卡': { 'zh-CN': '英文单词卡', en: 'English Flashcards', ja: '英単語カード', ko: '영어 단어 카드' },
  '單字學習工作區': { 'zh-CN': '单词学习工作区', en: 'Vocabulary learning workspace', ja: '単語学習ワークスペース', ko: '단어 학습 작업 공간' },
  '匯入 TSV、TXT、CSV 與試算表，查詢單字、進行語音練習與測驗，並檢視學習報表。': {
    'zh-CN': '导入 TSV、TXT、CSV 与电子表格，查询单词、进行语音练习与测验，并查看学习报告。',
    en: 'Import TSV, TXT, CSV, and spreadsheets to look up words, practice pronunciation, take quizzes, and review learning reports.',
    ja: 'TSV、TXT、CSV、スプレッドシートを読み込み、単語検索、発音練習、クイズ、学習レポートを利用できます。',
    ko: 'TSV, TXT, CSV 및 스프레드시트를 가져와 단어 검색, 발음 연습, 퀴즈 및 학습 보고서를 사용할 수 있습니다.'
  },
  '英文': { 'zh-CN': '英文', en: 'English', ja: '英語', ko: '영어' },
  '單字': { 'zh-CN': '单词', en: 'Vocabulary', ja: '単語', ko: '단어' },
  '測驗': { 'zh-CN': '测验', en: 'Quiz', ja: 'クイズ', ko: '퀴즈' },
  '語音': { 'zh-CN': '语音', en: 'Speech', ja: '音声', ko: '음성' },
  ...
  '假新聞多模態鑑識': { 'zh-CN': '假新闻多模态鉴识', en: 'Multimodal Fake-News Forensics', ja: 'マルチモーダル偽ニュース鑑識', ko: '멀티모달 가짜뉴스 포렌식' },
  '結合 YOLO 影像物件偵測、ELA 影像竄改鑑識、NLP 文字分析與 C++ 多模態融合的假新聞偵測平台。': { 'zh-CN': '结合 YOLO 影像物体检测、ELA 影像篡改鉴识、NLP 文字分析与 C++ 多模态融合的假新闻检测平台。', en: 'A fake-news detector combining YOLO object detection, ELA image-tamper forensics, NLP text analysis and C++ multimodal fusion.', ja: 'YOLO 物体検出、ELA 画像改ざん鑑識、NLP テキスト解析、C++ マルチモーダル融合を組み合わせた偽ニュース検出プラットフォーム。', ko: 'YOLO 객체 검출, ELA 이미지 변조 포렌식, NLP 텍스트 분석, C++ 멀티모달 융합을 결합한 가짜뉴스 탐지 플랫폼.' },
  '世界文化星球': { 'zh-CN': '世界文化星球', en: 'Cultura — World Cultures', ja: '世界文化プラネット', ko: '세계 문화 행성' },
  '文化': { 'zh-CN': '文化', en: 'Culture', ja: '文化', ko: '문화' },
  '地球': { 'zh-CN': '地球', en: 'Globe', ja: '地球', ko: '지구' },
  '世界': { 'zh-CN': '世界', en: 'World', ja: '世界', ko: '세계' },
  'AI': { 'zh-CN': 'AI', en: 'AI', ja: 'AI', ko: 'AI' },
  '假新聞': { 'zh-CN': '假新闻', en: 'Fake News', ja: '偽ニュース', ko: '가짜뉴스' },
  'YOLO': { 'zh-CN': 'YOLO', en: 'YOLO', ja: 'YOLO', ko: 'YOLO' },
  '電腦視覺': { 'zh-CN': '计算机视觉', en: 'Computer Vision', ja: 'コンピュータービジョン', ko: '컴퓨터 비전' },
  'NLP': { 'zh-CN': 'NLP', en: 'NLP', ja: 'NLP', ko: 'NLP' },
  '鑑識': { 'zh-CN': '鉴识', en: 'Forensics', ja: 'フォレンジック', ko: '포렌식' },
  '物聯網': { 'zh-CN': '物联网', en: 'IoT', ja: 'IoT', ko: 'IoT' },
  'MQTT': { 'zh-CN': 'MQTT', en: 'MQTT', ja: 'MQTT', ko: 'MQTT' },
  '數位孿生': { 'zh-CN': '数字孪生', en: 'Digital Twin', ja: 'デジタルツイン', ko: '디지털 트윈' },
  '擬真地球文化探索': { 'zh-CN': '拟真地球文化探索', en: 'Realistic-globe culture explorer', ja: 'リアル地球で文化探索', ko: '리얼 지구 문화 탐험' },
  '在擬真 3D 地球上探索世界各國文化，點擊文化標記聆聽程序化合成的在地音樂與語言問候。': { 'zh-CN': '在拟真 3D 地球上探索世界各国文化，点击文化标记聆听程序化合成的在地音乐与语言问候。', en: 'Explore world cultures on a realistic 3D globe — click markers to hear procedurally synthesised local music and spoken greetings.', ja: 'リアルな3D地球で世界の文化を探索。マーカーをクリックして、プログラムで合成された各地の音楽と挨拶を聴く。', ko: '사실적인 3D 지구에서 세계 문화를 탐험하고, 마커를 클릭해 절차적으로 합성된 현지 음악과 인사를 들어보세요.' },
  '智慧建築指揮中心': { 'zh-CN': '智慧建筑指挥中心', en: 'Smart-Building Command Center', ja: 'スマートビル指令センター', ko: '스마트 빌딩 지휘 센터' },
  '即時監控智慧建築裝置艦隊：手寫 MQTT broker、C++ 邊緣運算引擎、數位孿生與遙測儀表板。': { 'zh-CN': '实时监控智慧建筑设备舰队：手写 MQTT broker、C++ 边缘计算引擎、数字孪生与遥测仪表板。', en: 'Live-monitor a smart-building device fleet: a hand-rolled MQTT broker, a C++ edge-compute engine, a digital twin, and a telemetry dashboard.', ja: 'スマートビルのデバイス群をリアルタイム監視：自作MQTTブローカー、C++エッジ演算エンジン、デジタルツイン、テレメトリダッシュボード。', ko: '스마트 빌딩 장치 플릿 실시간 모니터링: 직접 구현한 MQTT 브로커, C++ 엣지 컴퓨트 엔진, 디지털 트윈, 텔레메트리 대시보드.' },
