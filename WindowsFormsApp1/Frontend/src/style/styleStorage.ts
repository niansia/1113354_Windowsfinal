...
const EYELINER_STYLES: EyelinerStyle[] = ['natural', 'tightline', 'puppy', 'wing', 'fox', 'smoky'];
const BROW_STYLES: BrowStyle[] = ['natural', 'straight', 'soft-arch', 'defined-arch', 'lifted'];
const LASH_STYLES: LashStyle[] = ['natural', 'doll', 'cat', 'wispy'];
