...
} from './developmentLabEngine.js';

export type DevelopmentLabModuleId =
  | LinearStructureKind
  | 'binary-tree'
  | SortAlgorithmId
  | SearchAlgorithmId
...
export interface DevelopmentLabModule {
  id: DevelopmentLabModuleId;
  group: 'structures' | 'algorithms';
  label: string;
  shortLabel: string;
  description: string;
  complexity: {
...
export const DEVELOPMENT_LAB_MODULES: DevelopmentLabModule[] = [
  {
    id: 'stack',
    group: 'structures',
    label: '堆疊',
...
export const getDevelopmentLabModule = (id: DevelopmentLabModuleId) =>
  DEVELOPMENT_LAB_MODULES.find((module) => module.id === id) ?? DEVELOPMENT_LAB_MODULES[0];

export const isAlgorithmModule = (id: DevelopmentLabModuleId): id is AlgorithmId =>
  [
    'bubble-sort',
    'insertion-sort',
    'selection-sort',
...
export const isSortModule = (id: DevelopmentLabModuleId): id is SortAlgorithmId =>
  ['bubble-sort', 'insertion-sort', 'selection-sort', 'quick-sort', 'merge-sort', 'heap-sort'].includes(id);
