...
exports.getAppById = exports.APP_CENTER_APPS = exports.PRIMARY_SHELL_APPS = exports.FUSION_APPS = void 0;
exports.FUSION_APPS = [
    {
        id: 'pc',
        title: '本機',
...
const PRIMARY_SHELL_IDS = ['pc', 'dir', 'tool', 'web', 'game', 'set'];
exports.PRIMARY_SHELL_APPS = PRIMARY_SHELL_IDS
    .map((id) => exports.FUSION_APPS.find((app) => app.id === id))
    .filter((app) => Boolean(app));
exports.APP_CENTER_APPS = exports.FUSION_APPS.filter((app) => !PRIMARY_SHELL_IDS.includes(app.id));
const getAppById = (id) => exports.FUSION_APPS.find((app) => app.id === id);
