...
exports.getFaceModel = exports.FACE_MODELS = void 0;
const pexels = (id, w = 900) => `https://images.pexels.com/photos/${id}/pexels-photo-${id}.jpeg?auto=compress&cs=tinysrgb&w=${w}`;
/**
...
const getFaceModel = (id) => exports.FACE_MODELS.find((model) => model.id === id) ?? exports.FACE_MODELS[0];
exports.getFaceModel = getFaceModel;
