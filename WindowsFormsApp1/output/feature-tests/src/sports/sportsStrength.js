...
exports.nationalTeamRating = nationalTeamRating;
exports.parseTeamRecord = parseTeamRecord;
exports.deriveSideMetrics = deriveSideMetrics;
exports.winPctLabel = winPctLabel;
...
function parseTeamRecord(record) {
