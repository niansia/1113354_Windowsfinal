...
exports.VOID_FORMS = void 0;
exports.fishFromCoord = fishFromCoord;
...
const COMMON = '春花秋月夜風雲雨雪山水江河海天地人心情愁思夢酒醉歌詩書劍馬舟車' +
...
function fishFromCoord(x, y, z, form) {
    ...
    for (let i = 0; i < lineCount; i += 1) {
        ...
        for (let j = 0; j < per; j += 1)
            line += COMMON[Math.floor(rnd() * COMMON.length)];
        lines.push(line);
    }
...
exports.VOID_FORMS = ['五絕', '七絕', '五律', '七律', '自由'];
